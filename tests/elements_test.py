...
class TestElements:
    ...
    class TestWebTable:
        ...
        def test_web_table_change_count_row(self, driver):
            ...
            assert count == [5, 10, 20, 25 , 50, 100], "The number of rows in the table has not been changes or has changed incorrectly"
    ...
    class TestButtonPage:
        ...
        def test_different_click_on_the_buttons(self, driver):
            ...
            assert click == "You have done a dynamic click", "The dinamic click button was not pressed"
    ...
    class TestLinksPage:
        ...
        def test_broken_link(self, driver):
            ...
            assert  response_code == 400, "the link works or thestatus code is son 400"
